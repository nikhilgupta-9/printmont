          ...
          <Col xs={12} lg={6}>
            <div className="p-0 p-lg-3 bg-white h-100 px-2">
              ...
              <div className="d-flex">
                <img src="/online-support.png" width={70} height={'auto'} className="me-2 text-secondary contact-icon" alt="Support" />
                <div>
                  <p className="mb-1">
                    Helpline no: <strong>+91-{helpline}</strong>
                  </p>
                  <p className="text-muted">({serviceTime})</p>
                </div>
              </div>
              ...
              <div className="mt-4">
                ...
                <div className="d-flex align-items-start">
                  <img src="/store-black.png" width={70} height={'auto'} className="me-2 me-lg-4 text-secondary contact-add-icon mt-2" alt="Factory" />
                  <div>
                ...
                <div className="d-flex align-items-start">
                  <img src="/store-black.png" width={70} height={'auto'} className="me-2 me-lg-4 text-secondary contact-add-icon mt-2" alt="Office" />
                  <div>
                    <strong className="mb-1">
                      Printmont Corporation.
                    </strong>
