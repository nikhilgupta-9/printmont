...
const sampleBanners = [
  {
    large: 'https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?auto=format&fit=crop&w=1200&q=80',
    small: 'https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?auto=format&fit=crop&w=600&q=80',
    title: 'Offer Banner 1',
    alt: 'Offer Banner 1',
    target: '/allproducts?q=shirt',
  },
  {
    large: 'https://images.unsplash.com/photo-1607082349566-187342175e2f?auto=format&fit=crop&w=1200&q=80',
    small: 'https://images.unsplash.com/photo-1607082349566-187342175e2f?auto=format&fit=crop&w=600&q=80',
    title: 'Offer Banner 2',
    alt: 'Offer Banner 2',
    target: '/allproducts?category=Fashion',
  },
  {
    large: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&w=1200&q=80',
    small: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&w=600&q=80',
    title: 'Offer Banner 3',
    alt: 'Offer Banner 3',
    target: '/allproducts?category=Electronics',
  },
  {
    large: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=1200&q=80',
  ...
  {
    large: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&w=1200&q=80',
    small: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&w=600&q=80',
    title: 'Offer Banner 5',
    alt: 'Offer Banner 5',
    target: '/allproducts',
  },
  {
    large: 'https://images.unsplash.com/photo-1560343090-f0409e92791a?auto=format&fit=crop&w=1200&q=80',
    small: 'https://images.unsplash.com/photo-1560343090-f0409e92791a?auto=format&fit=crop&w=600&q=80',
...
export default function BannerPreview() {
  const baseURL = import.meta.env.VITE_BASE_URL || 'https://mediumvioletred-pelican-783174.hostingersite.com/';

  return (
    <div className="container py-4 my-3">
      <div className="text-center mb-5 border-bottom pb-4">
        <h1 className="fw-bold text-dark">🖼️ Banner & Slider Layout Formats Showcase</h1>
        <p className="text-muted fs-5">
          Temporary Preview Page to inspect all Static Banner Formats & Carousel Slider Formats.
        </p>
        <span className="badge bg-primary fs-6 px-3 py-2">URL Route: /banner-preview</span>
      </div>
      ...
      <div className="mb-5 p-4 rounded bg-light border">
        <h2 className="text-danger fw-bold mb-4">📷 IMAGE 1: STATIC BANNER LAYOUTS</h2>

        {/* 1. 6-Square Grid (3x2 Layout) */}
        <div className="mb-5 border p-3 bg-white rounded">
      ...
      {/* ========================================================= */}
      <div className="mb-5 p-4 rounded bg-light border">
        <h2 className="text-danger fw-bold mb-4">🎠 IMAGE 2: CAROUSEL & SLIDER BANNER LAYOUTS</h2>
