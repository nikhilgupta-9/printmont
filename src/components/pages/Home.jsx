            ...
            {loading ? (
              ...
              <>
                 ...
                 <LazySection skeleton={<CarouselSkeleton />}>
                   <ProductCarousel apiUrl={`${baseURL}api/products/products.php?action=bestseller`} title="Our Bestsellers" badgeText="Customizable" />
                 </LazySection>
                 ...
                 <LazySection skeleton={<CarouselSkeleton />}>
                   <ProductCarousel apiUrl={`${baseURL}api/products/products.php?action=top_selection`} title="Top Selection" badgeText="Customizable" />
                 </LazySection>
                 ...
                 <LazySection skeleton={<CarouselSkeleton />}>
                   <ProductCarousel apiUrl={`${baseURL}api/products/products.php?action=discount_for_you`} title="Discount For You" badgeText="Customizable" />
                 </LazySection>
                 ...
                 <LazySection skeleton={<CarouselSkeleton />}>
                   <ProductCarousel apiUrl={`${baseURL}api/products/products.php?action=top_rated`} title="Top Rated" badgeText="Customizable" />
                 </LazySection>
                 ...
                 <LazySection skeleton={<CarouselSkeleton />}>
                   <ProductCarousel apiUrl={`${baseURL}api/products/products.php?action=top_deal`} title="Top Deals and Categories" badgeText="Customizable" />
                 </LazySection>
                 ...
                 <LazySection skeleton={<CarouselSkeleton />}>
                   <ProductCarousel apiUrl={`${baseURL}api/products/products.php?action=top_selection`} title="Women's Outfits" />
                 </LazySection>
                 ...
                 <LazySection skeleton={<CarouselSkeleton />}>
                   <ProductCarousel apiUrl={`${baseURL}api/products/products.php?action=discount_for_you`} title="Recently Viewed" />
                 </LazySection>
