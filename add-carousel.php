...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if ($carouselController->createCarousel($data)) {
            $_SESSION['success_message'] = "Carousel created successfully!";
            header("Location: carousels.php");
            exit();
        }
        throw new Exception("Failed to create carousel.");
    } catch (Exception $e) {
...
$formAction  = 'add-carousel.php';
$submitLabel = 'Create Carousel';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Add Carousel | Printmont</title>
                ...
                <div class="container-fluid p-0">
                    <div class="row mb-2 mb-xl-3">
                        <div class="col-auto d-none d-sm-block">
                            <h3><strong>Add</strong> Carousel</h3>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <h6 class="card-subtitle text-muted">Create a new product carousel.</h6>
                                </div>
                                <div class="card-body">
