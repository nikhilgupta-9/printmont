...
$orders_data = $orderController->getDeliveredOrders($page, $limit, $filters);
...
<head>
    ...
    <title>Delivered Orders | Printmont</title>
                ...
                <div class="container-fluid p-0">
                    <div class="row mb-2 mb-xl-3">
                        <div class="col-auto d-none d-sm-block">
                            <h3><strong>Delivered</strong> Orders</h3>
                        </div>
                        <div class="col-auto ms-auto text-end mt-n1">
                            <span class="badge bg-warning text-dark">
                                <?php echo number_format($order_counts['delivered']['count'] ?? 0); ?> Delivered
                            </span>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title">Devlivered Orders (
                                        <?php echo number_format($orders_data['total_count']); ?>)
                                    </h5>
                                    <h6 class="card-subtitle text-muted">Orders waiting for processing. Sort by oldest
                                        first for priority.</h6>
                                </div>
                                <div class="card-body">
                                    <?php if (empty($orders)): ?>
                                        <div class="text-center py-4">
                                            <i class="fas fa-check-circle fa-3x text-success mb-3"></i>
                                            <h5>No Devlivered Orders</h5>
                                            <p class="text-muted">All orders have been Devlivered. Great job!</p>
                                        </div>
                                    <?php else: ?>
                                            ...
                                            <table class="table table-striped table-hover order-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($orders as $order):
                                                        ...
                                                        ?>
                                                        <tr
                                                            class="<?php echo $is_urgent ? 'urgent-order' : ($is_new ? 'new-order' : ''); ?>">
                                                            <td>
                                                                <?= $sno++ ?>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <strong>$
                                                                    <?php echo number_format($order['grand_total'] ?? $order['total_amount'], 2); ?>
                                                                </strong>
                                                            </td>
                                                            <td>
                                                                <span
                                                            ...
                                                            <td>
                                                                <small
                                                                    class="<?php echo $is_urgent ? 'text-danger' : 'text-muted'; ?>">
                                                                    <?php
