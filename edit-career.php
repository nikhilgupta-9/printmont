...
if (!$career_id) {
    $_SESSION['error_message'] = "Invalid career ID";
...
if (!$career) {
    $_SESSION['error_message'] = "Career posting not found";
    header("Location: careers.php");
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Update career
        $result = $careerController->updateCareer($career_id, $data);
...
<body>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <p class="text-muted mb-0">Update job posting information</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="career-info-card">
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <h4 class="text-white mb-1"><?php echo htmlspecialchars($career['job_title']); ?></h4>
                                        <p class="text-white-50 mb-0">
                                            <i class="fas fa-map-marker-alt me-1"></i><?php echo htmlspecialchars($career['location']); ?> • 
                                            <i class="fas fa-calendar me-1"></i>Posted: <?php echo date('M j, Y', strtotime($career['created_at'])); ?> • 
                                            <i class="fas fa-users me-1"></i><?php echo $career['applications_count']; ?> Applications
                                        </p>
                                    </div>
                                    <div class="col-md-4 text-end">
                                        <span class="badge bg-<?php echo $career['is_active'] ? 'success' : 'secondary'; ?> me-2">
                                            <?php echo $career['is_active'] ? 'Active' : 'Inactive'; ?>
                                        </span>
                                        <span class="badge bg-light text-dark">
                                            ID: <?php echo $career['id']; ?>
                                        </span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <form method="POST" id="careerForm">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="job_title" name="job_title" 
                                                               ...
                                                               maxlength="255">
                                                        <div class="character-counter" id="job_title_counter"><?php echo strlen($career['job_title']); ?>/255 characters</div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="location" name="location" 
                                                               ...
                                                               maxlength="255">
                                                        <div class="character-counter" id="location_counter"><?php echo strlen($career['location']); ?>/255 characters</div>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <select class="form-select" id="department" name="department" required>
                                                            ...
                                                            <?php foreach ($departments as $value => $label): ?>
                                                                <option value="<?php echo $value; ?>" 
                                                                        <?php echo $career['department'] == $value ? 'selected' : ''; ?>>
                                                                    <?php echo $label; ?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="form-select" id="job_type" name="job_type" required>
                                                            ...
                                                            <?php foreach ($jobTypes as $value => $label): ?>
                                                                <option value="<?php echo $value; ?>" 
                                                                        <?php echo $career['job_type'] == $value ? 'selected' : ''; ?>>
                                                                    <?php echo $label; ?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="form-check form-switch mt-2">
                                                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" 
                                                                   <?php echo $career['is_active'] ? 'checked' : ''; ?>>
                                        ...
                                        <div class="form-section">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="description" name="description" rows="6" 
                                                          ...
                                                          maxlength="5000"><?php echo htmlspecialchars($career['description']); ?></textarea>
                                                <div class="character-counter" id="description_counter"><?php echo strlen($career['description']); ?>/5000 characters</div>
                                        ...
                                        <div class="form-section">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="responsibilities" name="responsibilities" rows="6" 
                                                          ...
                                                          maxlength="3000"><?php echo htmlspecialchars($career['responsibilities']); ?></textarea>
                                                <div class="character-counter" id="responsibilities_counter"><?php echo strlen($career['responsibilities']); ?>/3000 characters</div>
                                        ...
                                        <div class="form-section">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="requirements" name="requirements" rows="6" 
                                                          ...
                                                          maxlength="3000"><?php echo htmlspecialchars($career['requirements']); ?></textarea>
                                                <div class="character-counter" id="requirements_counter"><?php echo strlen($career['requirements']); ?>/3000 characters</div>
                                        ...
                                        <div class="mt-4 pt-3 border-top">
                                            ...
                                            <a href="view-career.php?id=<?php echo $career_id; ?>" class="btn btn-outline-primary btn-lg">
    ...
    <!-- Preview Modal (same as add-career.php) -->
