...
$orders_data = $orderController->getcompletedOrders($limit, $page, $filters);
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title">Delivered Orders (<?php echo number_format($total_count); ?>)</h5>
                                    <h6 class="card-subtitle text-muted">Orders that have been delivered to customers.</h6>
                                </div>
                                <div class="card-body">
                                    <?php if (empty($orders)): ?>
                                        <div class="text-center py-4">
                                            ...
                                            <p class="text-muted">No orders have been delivered yet.</p>
                                        </div>
                                    <?php else: ?>
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover order-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr class="<?php echo $is_new ? 'new-order' : ''; ?>">
                                                            <td>
                                                            ...
                                                            <td class="action-buttons">
                                                                ...
                                                                <a href="receipt.php?id=<?php echo $order['id']; ?>" 
                                                                   class="btn btn-sm btn-success" title="Receipt">
