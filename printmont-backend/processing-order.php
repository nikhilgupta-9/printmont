...
$orders_data = $orderController->getShippedOrders($page, $limit, $filters);
                    ...
                    <div class="row mb-2 mb-xl-3">
                        ...
                        <div class="col-auto ms-auto text-end mt-n1">
                            <span class="badge bg-warning text-dark">
                                <?php echo number_format($order_counts['pending']['count'] ?? 0); ?> Processing
                            </span>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title">Processing Orders (<?php echo number_format($orders_data['total_count']); ?>)</h5>
