...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        if ($categoryController->createCategory($data)) {
            ...
            throw new Exception("Failed to create sub category. Error: " . $conn->error);
        }
    } catch (Exception $e) {
...
<body data-theme="default" data-layout="fluid" data-sidebar-position="left" data-sidebar-layout="default">
                ...
                <div class="container-fluid p-0">
                    <div class="row mb-2 mb-xl-3">
                        <div class="col-auto d-none d-sm-block">
                            <h3><strong>Add Sub</strong> Category</h3>
                        </div>
                        <div class="col-auto ms-auto text-end mt-n1">
                            <a href="view-categories.php?level=2" class="btn btn-secondary">View Sub Categories</a>
                        </div>
                    </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body p-2">
                            <ul class="nav nav-tabs" id="categoryTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" href="add-sub-category.php">
                        ...
                        <div class="col-12 col-md-8">
                            <div class="card">
                                <div class="bg-primary p-3">
                                    <h5 class="test-light mb-0">Sub Category Information</h5>
                                    <h6 class="card-subtitle text-white">Add new sub category (Level 2)</h6>
                                </div>
                                <div class="card-body">
                                    <form method="POST" id="categoryForm" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="parent_id" class="form-label required">Main
                                                        Category</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label for="name" class="form-label required">Sub Category
                                                        Name</label>
                                                    <input type="text" class="form-control" id="name" name="name"
                                                        value="<?php echo isset($_POST['name']) ? htmlspecialchars($_POST['name']) : ''; ?>"
                                                        required maxlength="255" placeholder="e.g., T-Shirts">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="description" name="description"
                                                rows="3" maxlength="500" placeholder="Brief description of the sub category"><?php echo isset($_POST['description']) ? htmlspecialchars($_POST['description']) : ''; ?></textarea>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="is_featured">
                                                    <i class="fas fa-star text-warning me-1"></i> Featured Sub Category
                                                </label>
                                            </div>
                                        </div>
                            ...
                            <div class="card shadow-sm border-0">
                                ...
                                <div class="card-body">
                                    <div class="alert alert-success p-3 mb-3">
                                        ...
                                        <ul class="mb-0 ps-3">
                                            <li>This is a <strong class="text-success">Level 2</strong> category</li>
                                            <li>Must have a Main Category as parent</li>
                                            <li>Can have Sub Sub Categories</li>
                                            <li>Will appear under selected main category</li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="alert alert-info p-3">
                                        ...
                                        <p class="mb-0">You must create a Main Category first before adding Sub Categories.</p>
                                    </div>
                                    ...
                                    <div class="text-center mt-3">
                                        <div class="btn-group-vertical w-100" role="group">
                                            ...
                                            <a href="add-sub-sub-category.php" class="btn btn-warning btn-sm">
                                                <i class="fas fa-plus me-1"></i> Add Sub Sub Category
                                            </a>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        // Auto-generate slug with parent category
