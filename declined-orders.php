...
$orders_data = $orderController->getCancelledOrders($page, $limit, $filters);
...
<head>
    ...
    <title>Declined Orders | Printmont</title>
                ...
                <div class="container-fluid p-0">
                    <div class="row mb-2 mb-xl-3">
                        <div class="col-auto d-none d-sm-block">
                            <h3><strong>Declined</strong> Orders</h3>
                        </div>
                        <div class="col-auto ms-auto text-end mt-n1">
                            <span class="badge bg-warning text-dark">
                                <?php echo number_format($order_counts['cancelled']['count'] ?? 0); ?> Declined
                            </span>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title">Declined Orders (
                                        <?php echo number_format($orders_data['total_count']); ?>)
                                    </h5>
                                    <h6 class="card-subtitle text-muted">Orders waiting for Completed. Sort by oldest
                                ...
                                <div class="card-body">
                                    <?php if (empty($orders)): ?>
                                        <div class="text-center py-4">
                                            ...
                                            <p class="text-muted">All orders have been Completed. Great job!</p>
                                        </div>
                                    <?php else: ?>
