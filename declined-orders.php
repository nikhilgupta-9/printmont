                ...
                <div class="container-fluid p-0">
                    <div class="row mb-2 mb-xl-3">
                        <div class="col-auto d-none d-sm-block">
                            <h3><strong>Cancelled</strong> Orders</h3>
                        </div>
                        <div class="col-auto ms-auto text-end mt-n1">
                            <span class="badge bg-warning text-dark">
                                <?php echo number_format($order_counts['pending']['count'] ?? 0); ?> Cancelled
                            </span>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title">Cancelled Orders (<?php echo number_format($orders_data['total_count']); ?>)</h5>
                                    <h6 class="card-subtitle text-muted">Orders waiting for Cancelled. Sort by oldest first for priority.</h6>
                                </div>
                                <div class="card-body">
                                    <?php if (empty($orders)): ?>
