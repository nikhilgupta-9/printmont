...
try {
    ...
    $error_message = 'Unable to connect to the database. Please verify MySQL is running and the credentials in config/database.php.';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['login']) && $authController !== null) {
    $email = $_POST['email'] ?? '';
