...
$orders_data = $orderController->getProcessingOrders($page, $limit, $filters);
                ...
                <div class="container-fluid p-0">
                    <div class="row mb-2 mb-xl-3">
                        <div class="col-auto d-none d-sm-block">
                            <h3><strong>Processing</strong> Orders</h3>
                        </div>
                        <div class="col-auto ms-auto text-end mt-n1">
                            <span class="badge bg-warning text-dark">
                                <?php echo number_format($order_counts['processing']['count'] ?? 0); ?> Processing
                            </span>
                        </div>
                    </div>
