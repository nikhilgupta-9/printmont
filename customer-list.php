                ...
                <div class="container-fluid p-0">
                    <div class="row mb-2 mb-xl-3">
                        <div class="col-auto d-none d-sm-block">
                            <h3><strong>Customer</strong> Management</h3>
                        </div>
                    </div>
                    ...
                    <div class="card p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <p><strong>Total Orders:</strong> <span id="cd-orders"></span></p>
                                <p><strong>Address:</strong> <span id="cd-address"></span></p>
                                <p><strong>Active Order:</strong> <span id="cd-active"></span></p>
                            </div>
                        </div>
