                ...
                <div class="container-fluid p-0">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <p class="text-muted">Manage layouts, sliders, banners, and product sections for desktop and
                                mobile homepages.</p>
                        </div>
                                ...
                                <div class="card-header p-0">
                                    <ul class="nav nav-tabs card-header-tabs m-0" id="layoutTabs" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active py-3 px-4" id="desktop-tab"
                                                data-bs-toggle="tab" data-bs-target="#desktop-pane" type="button"
                                                role="tab"><i class="fas fa-desktop tab-icon text-primary"></i>Desktop
                                                Homepage</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link py-3 px-4" id="mobile-tab" data-bs-toggle="tab"
                                                data-bs-target="#mobile-pane" type="button" role="tab"><i
                                                    class="fas fa-mobile-alt tab-icon text-success"></i>Mobile
                                                Homepage</button>
                                        </li>
                                    </ul>
                                </div>
                                <div class="card-body">
                                    <div class="tab-content" id="layoutTabContent">
                                        ...
                                        <div class="tab-pane fade show active" id="desktop-pane" role="tabpanel">
                                            <div class="alert alert-info py-2"><i
                                                    class="fas fa-info-circle me-2"></i>Drag and drop sections to
                                                rearrange their order on the desktop homepage. Changes are saved
                                                automatically.</div>
                                            <div id="desktop-list" class="list-group">
                                                <?php foreach ($desktopSections as $sec): ?>
                                                    <div class="list-group-item sortable-item d-flex align-items-center justify-content-between p-3 mb-2 rounded shadow-sm"
                                                        data-id="<?php echo $sec['id']; ?>"
                                                        style="border-left-color: <?php echo getBorderColor($sec['section_type']); ?>">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ms-3">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <span
                                                                        class="badge bg-light text-dark border py-1 px-2 type-badge"><?php echo str_replace('_', ' ', $sec['section_type']); ?></span>
                                                                    <span>Key:
                                                                        <code><?php echo htmlspecialchars($sec['section_key']); ?></code></span>
                                                                    <?php if ($sec['api_action']): ?>
                                                                        <span>Action:
                                                                            <strong><?php echo htmlspecialchars($sec['api_action']); ?></strong></span>
                                                                    <?php endif; ?>
                                                                    <?php if ($sec['product_limit']): ?>
                                                                        <span>Limit:
                                                                            <strong><?php echo $sec['product_limit']; ?></strong></span>
                                                                    <?php endif; ?>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="d-none d-md-flex align-items-center gap-1 me-2">
                                                                    <?php foreach (array_slice($sec['banners'], 0, 4) as $banner): ?>
                                                                        <img src="<?php echo htmlspecialchars($banner['image_url_desktop']); ?>"
                                                                            class="preview-img-thumbnail" alt="thumbnail"
                                                                            title="<?php echo htmlspecialchars($banner['title']); ?>">
                                                                    <?php endforeach; ?>
                                                                    <?php if (count($sec['banners']) > 4): ?>
                                                                        <span
                                                                            class="badge bg-secondary">+<?php echo count($sec['banners']) - 4; ?></span>
                                                                    <?php endif; ?>
                                                                </div>
                                                            <?php endif; ?>
                                                            <label class="switch m-0">
                                                                <input type="checkbox"
                                                                    onchange="toggleSection(<?php echo $sec['id']; ?>, this.checked)"
                                                                    <?php echo $sec['status'] === 'active' ? 'checked' : ''; ?>>
                                                                <span class="slider-switch"></span>
                                                            </label>
                                                            <button class="btn btn-sm btn-outline-primary"
                                                                onclick="openEditModal(<?php echo htmlspecialchars(json_encode($sec)); ?>)"><i
                                                                    class="fas fa-edit"></i> Edit</button>
                                                            <button class="btn btn-sm btn-outline-danger"
                                                                onclick="deleteSection(<?php echo $sec['id']; ?>)"><i
                                        ...
                                        <div class="tab-pane fade" id="mobile-pane" role="tabpanel">
                                            <div class="alert alert-info py-2"><i
                                                    class="fas fa-info-circle me-2"></i>Drag and drop sections to
                                                rearrange their order on the mobile homepage. Changes are saved
                                                automatically.</div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="section-label" name="label" required
                                    placeholder="e.g. Hot Deals Carousel">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3" id="section-key-container">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="section-key" name="section_key"
                                    placeholder="Generate automatically if left blank">
                                <div class="form-text text-muted">Use standard alphanumeric characters & underscores.
                                    Must be unique.</div>
                            </div>
                        </div>
                        ...
                        <div id="banner-slider-options" style="display: none;">
                            <div class="row mb-3 align-items-end">
                                ...
                                <div class="col-md-6 text-end">
                                    <button type="button" class="btn btn-secondary btn-sm" id="add-slide-btn"
                                        onclick="addNewSlideSlot()" style="display: none;">
                        ...
                        <div id="product-options" style="display: none;">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="product-badge-text" name="badge_text"
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="product-bg-image"
                                        name="background_image_url" placeholder="e.g. ./bg/flashsale.png">
                                </div>
                            </div>
                        </div>
                    </div>
